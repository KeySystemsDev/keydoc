									...
									if($horarios){
										...
										foreach ($horarios as $key) {
											...
											'<tr>
												...
												<td>';
													if ($this->session->userdata('id_usuario')){
														echo '<a href="'.base_url().'citas/agendar-horario/doctor-'.base64_encode($key->id_usuario).'/horario-'.base64_encode($key->id_horario).'"><span class="btn btn-sm btn-success"><i class="fa fa-check"></i> Agendar</span></a>';
													}else{
...
<?php echo '<pre>'; print_r($horarios); echo '</pre>'; ?>