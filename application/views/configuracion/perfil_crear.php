  ...
  $(function() { 
	...
	$('#b_enviar').click(function(event) {     
	  ...
	  && e != 0 && f != 0 && g != 0 && h != 0){               
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo base_url()?>configuracion/perfil_agregar',
		  data: datos,
...
<section class="content-header">
  	<ol class="breadcrumb">
		<li><a href="<?php echo base_url().'configuracion/perfil'?>"><i class="fa fa-cogs"></i> Perfil</a></li>
...
<section class="content">  
  	<div class="col-md-4" align="center">
		...
		<a href="<?php echo base_url();?>configuracion/foto" class="btn btn-info col-md-12"> 
