	...
	$(function() {
		...
		$('#b_enviar').click(function(event) {     
			...
			&& e != 0 && f != 0 && g != 0){               
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url()?>configuracion/perfil_actualizar',
					data: datos,
...
<section class="content-header">
	<ol class="breadcrumb">
		<li><a href="<?php echo base_url().'configuracion/perfil'?>"><i class="fa fa-cogs"></i> Editando el Perfil</a></li>
	</ol>   
</section>
<?php
...
<section class="content">  
	<div class="col-md-4" align="center">
		...
		<div class="btn-group">
			<a href="<?php echo base_url();?>configuracion/foto" class="btn btn-info">Subir Foto</a>
			<a href="<?php echo base_url();?>configuracion/foto" class="btn btn-info">
