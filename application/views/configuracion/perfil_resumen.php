<section class="content-header">
	<ol class="breadcrumb">
		<li><i class="fa fa-cogs"></i> Perfil</li>
	</ol>
</section>
								...
								<div class="col-sm-6">
									<div class="btn-group">
										...
										<ul class="dropdown-menu" role="menu">
											<li><a href="<?php echo base_url().'configuracion/perfil-contrasena'?>">Cambiar Contraseña</a></li>
											<li><a href="<?php echo base_url().'configuracion/perfil-editar'?>">Editar Perfil</a></li>
											<li class="divider"></li>
											<li><a href="<?php echo base_url().'panel'?>">Ir al Panel</a></li>
										</ul>
									</div>                
								</div>
							</div>
