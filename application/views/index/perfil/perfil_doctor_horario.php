							...
							<ul class="list-group">
								<?php
									foreach ($doctor as $key) {
										$id_doctor = $key->id_usuario;
										echo
										'<a href="'.base_url().'agendar/" class="list-group-item disabled">
								...
								<?php             
									if ($amistad) {
										...
										if ($this->session->userdata('id_usuario')) {
											...
											echo '<a href="'.base_url().'sesion"><span class="btn btn-lg btn-primary col-md-12"><i class="fa fa-check"></i> Ingresar</span></a>';
										}
									}                  
								?>                                                    
							</div>              
									...
									if($horarios){
										...
										foreach ($horarios as $key) {
											...
											'<tr>
												...
												<td>';
													if ($this->session->userdata('id_usuario')){
														echo '<a href="'.base_url().'agendar-horario/doctor-'.base64_encode($id_doctor).'/horario-'.base64_encode($key->id_horario).'"><span class="btn btn-sm btn-success"><i class="fa fa-check"></i> Agendar</span></a>';
													}else{
														echo '<a href="'.base_url().'sesion"><span class="btn btn-sm btn-primary"><i class="fa fa-check"></i> Ingresar</span></a>';
													}
												echo
												'</td>
										  </tr>';
