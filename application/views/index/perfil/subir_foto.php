		...
		<div class="col-md-4 col-md-push-4">
			<div class="bod-body">
				...
				<div class="thumbnail">
					...
					<!--<p><a href="<?php echo base_url().'foto';?>">Add another</a></p>-->
				</div> 
				<div class="form-group" align="center">
					<div class="btn-group">
						<a href="<?php echo base_url();?>perfil" class="btn btn-info">Ver Perfil</a>
						<a href="<?php echo base_url();?>perfil" class="btn btn-info">
			...
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-3" style="margin: 10px 0px;">
						<div class="form-group" align="center">
							<form name="thumbnail" action="<?php echo base_url().'foto';?>" method="post">
	...
	<?php else : ?>
		...
		<div class="col-md-4 col-md-push-4">
			<div class="bod-body">
				...
				<form name="photo" enctype="multipart/form-data" action="<?php echo base_url().'foto';?>" method="post">
